...
class MainActivityTest {
 ...
 /*@Rule @JvmField
  var intentTestRule: IntentsTestRule<MainActivity> = IntentsTestRule(MainActivity::class.java)*/
  ...
  fun testIntentedActivityOnItemClickRecyclerView(){
    onView(withId(R.id.coffee_list)).perform(RecyclerViewActions.scrollToPosition<RecyclerView.ViewHolder>(1))
    onView(withId(R.id.coffee_list)).perform(RecyclerViewActions.actionOnItemAtPosition<RecyclerView.ViewHolder>(1,click()))
